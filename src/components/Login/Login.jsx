...
const Login = () => {
    ...
    return (
        <div className='bg-orange-300 border-2 rounded-xl border-black-700 p-3 m-3 w-2/4 mx-auto'>
            <h2 className="text-2xl text-center font-extrabold m-4">Please Login</h2>

            <form onSubmit={handleLogin}>
                <input type="text" placeholder='enter name' name="name" id="" required className='border-2 w-3/4 border-red-600 mb-2 p-2' />
                <br />
                ...
                <br />
                <br />
                <input type="submit" value="Login" className='border-2 bg-orange-600 text-white font-bold border-red-600 p-2 rounded-lg w-full mb-4' />
            </form>
